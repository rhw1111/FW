...
{
    [Injection(InterfaceType = typeof(ExceptionRetryCheckHandleForDbUpdateException), Scope = InjectionScope.Singleton)]
    public class ExceptionRetryCheckHandleForDbUpdateException : IExceptionRetryCheckHandle
    {
