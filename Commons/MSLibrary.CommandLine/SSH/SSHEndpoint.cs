...
namespace MSLibrary.CommandLine.SSH
{
    public class SSHEndpoint : EntityBase<ISSHEndpointIMP>
    {
        ...
        public async Task<int> TransferFile(Func<string, Task<string>> fileNameGenerateAction, string fromPath, string toPath, int timeoutSeconds = -1, CancellationToken cancellationToken = default)
        {
            return await _imp.TransferFile(this, fileNameGenerateAction, fromPath,toPath, timeoutSeconds, cancellationToken);
        }
    ...
    public interface ISSHEndpointIMP
    {
        ...
        Task<int> TransferFile(SSHEndpoint endpoint, Func<string, Task<string>> fileNameGenerateAction, string fromPath, string toPath, int timeoutSeconds = -1, CancellationToken cancellationToken = default);
    ...
    public interface ISSHEndpointService
    {
        ...
        Task<int> TransferFile(string configuration, Func<string,Task<string>> fileNameGenerateAction, string fromPath, string toPath, int timeoutSeconds = -1, CancellationToken cancellationToken = default);
    ...
    public class SSHEndpointIMP : ISSHEndpointIMP
    {
        ...
        public async Task<int> TransferFile(SSHEndpoint endpoint, Func<string, Task<string>> fileNameGenerateAction, string fromPath, string toPath, int timeoutSeconds = -1, CancellationToken cancellationToken = default)
        {
            var service = getService(endpoint.Type);
            return await service.TransferFile(await getContent(endpoint.Configuration), fileNameGenerateAction, fromPath, toPath, timeoutSeconds, cancellationToken);
        }
