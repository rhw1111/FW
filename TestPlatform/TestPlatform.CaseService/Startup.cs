    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddControllers((opts) =>
            {
                ...
                opts.Filters.Add(DIContainerContainer.Get<ExceptionFilter>(LoggerCategoryNames.TestPlatform_Portal_Api, coreConfiguration.Debug,false));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseExceptionWrapper(LoggerCategoryNames.HttpRequest, applicationConfiguration.Debug,true);
