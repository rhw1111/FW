...
namespace FW.TestPlatform.Main.Application
{
    public interface IAppExecuteTestCase
    {
        ...
        Task AddSlaveHost(TestCaseSlaveHost slaveHost, CancellationToken cancellationToken = default);
        ...
        Task UpdateSlaveHost(TestCaseSlaveHost slaveHost, CancellationToken cancellationToken = default);
    }
}
