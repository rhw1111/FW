...
namespace FW.TestPlatform.Main.Code.GenerateAdditionFuncServices
{
    ...
    /// 针对Locust的附件函数生成服务
    /// </summary>
    [Injection(InterfaceType = typeof(GenerateAdditionFuncServiceForLocustWebSocketWithConnect), Scope = InjectionScope.Singleton)]
    public class GenerateAdditionFuncServiceForLocustWebSocketWithConnect : IGenerateAdditionFuncService
    {
        public async Task<string> Generate()
        {
            StringBuilder sbCode = new StringBuilder();
            sbCode.AppendLine("def WebSocketWithConnect(connect, senddata, receivereg, name=None, self=None):");
            sbCode.AppendLine("    # print(\"WebSocketWithConnect\")");
            sbCode.AppendLine("    import socket");
            sbCode.AppendLine("    import websocket");
