...
namespace FW.TestPlatform.Main.Entities.TestCaseHandleServices
{
    ...
    public class TestCaseHandleServiceForHttp : ITestCaseHandleService
    {
        ...
        public TestCaseHandleServiceForHttp(ITestDataSourceRepository testDataSourceRepository, IScriptTemplateRepository scriptTemplateRepository, ISSHEndpointRepository sshEndpointRepository, ISystemConfigurationService systemConfigurationService, ITestCaseStore testCaseStore, ITreeEntityStore treeEntityStore)
        {
