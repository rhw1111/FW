...
namespace FW.TestPlatform.Main.Entities.TestCaseHandleServices
{
    ...
    public class TestCaseHandleServiceForTcp : ITestCaseHandleService
    {
        ...
        public TestCaseHandleServiceForTcp(ITestDataSourceRepository testDataSourceRepository, IScriptTemplateRepository scriptTemplateRepository, ISSHEndpointRepository sshEndpointRepository, ISystemConfigurationService systemConfigurationService, ITestCaseStore testCaseStore, ITreeEntityStore treeEntityStore)
        {
