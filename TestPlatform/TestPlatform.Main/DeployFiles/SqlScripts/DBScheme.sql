...
REPLACE INTO `systemconfiguration` (`id`, `name`, `content`, `createtime`, `modifytime`, `sequence`) VALUES
	...
	('3e552936-af6f-11ea-8e6a-0242ac110002', 'TestPlatform.Portal.Api_CrosOrigin', '["http://52.188.14.158:80/","http://localhost:80/"]', '2020-06-16 01:18:11', '2020-06-16 01:18:11', 2),
	...
	('d4fdc4e2-4efd-4a1c-8372-5a6eca74e381', 'TestPlatform.CaseService_CrosOrigin', '["http://52.188.14.158:8082/","http://localhost:8082/"]', '2020-06-27 13:23:45', '2020-06-27 13:23:45', 6),
	('d2be1a01-bcd9-11ea-813c-025041000001', 'Tcp_TestMonitorAddress', '"http://52.188.14.158:8082/"', now(), now(), 7),
	('1316b30b-bcdb-11ea-813c-025041000001', 'Http_TestMonitorAddress', '"http://52.188.14.158:8082/"', now(), now(), 8);
