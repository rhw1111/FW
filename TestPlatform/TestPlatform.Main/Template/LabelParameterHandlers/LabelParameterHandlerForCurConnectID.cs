...
namespace FW.TestPlatform.Main.Template.LabelParameterHandlers
{
    ...
    public class LabelParameterHandlerForCurConnectID : ILabelParameterHandler
    {
        ...
        public LabelParameterHandlerForCurConnectID(ISelector<IFactory<IGenerateVarInvokeService>> generateVarInvokeServiceSelector, ISelector<IFactory<IGetSeparatorService>> getSeparatorServiceSelector)
        {
        ...
        public async Task<string> Execute(TemplateContext context, string[] parameters)
        {
            ...
            string strTemp = await funService.Generate("self.user_id", parameters);
