...
namespace FW.TestPlatform.Main.Template.LabelParameterHandlers
{
    ...
    [Injection(InterfaceType = typeof(LabelParameterHandlerForCurConnect), Scope = InjectionScope.Singleton)]
    public class LabelParameterHandlerForCurConnect : ILabelParameterHandler
    {
        private readonly ISelector<IFactory<IGenerateVarInvokeService>> _generateVarInvokeServiceSelector;
        private readonly ISelector<IFactory<IGetSeparatorService>> _getSeparatorServiceSelector;

        public LabelParameterHandlerForCurConnect(ISelector<IFactory<IGenerateVarInvokeService>> generateVarInvokeServiceSelector, ISelector<IFactory<IGetSeparatorService>> getSeparatorServiceSelector)
        {
        ...
        public async Task<string> Execute(TemplateContext context, string[] parameters)
        {
            ...
            string strTemp = await funService.Generate("self.client", parameters);
