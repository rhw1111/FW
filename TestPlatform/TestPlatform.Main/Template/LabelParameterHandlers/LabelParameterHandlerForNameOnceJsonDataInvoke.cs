...
namespace FW.TestPlatform.Main.Template.LabelParameterHandlers
{
    ...
    public class LabelParameterHandlerForNameOnceJsonDataInvoke : ILabelParameterHandler
    {
        ...
        public LabelParameterHandlerForNameOnceJsonDataInvoke(ISelector<IFactory<IGetSeparatorService>> getSeparatorServiceSelector)
        {
        ...
        public async Task<string> Execute(TemplateContext context, string[] parameters)
        {
            ...
            strCode.Append($"NameOnceJsonData({parameters[0]})");
