...
namespace FW.TestPlatform.Main.Template.LabelParameterHandlers
{
    ...
    public class LabelParameterHandlerForDecimalRange : ILabelParameterHandler
    {
        ...
        public LabelParameterHandlerForDecimalRange(ISelector<IFactory<IGenerateFuncInvokeService>> generateFuncInvokeServiceSelector, ISelector<IFactory<IGetSeparatorService>> getSeparatorServiceSelector)
        {
        ...
        public async Task<string> Execute(TemplateContext context, string[] parameters)
        {
            ...
            string strTemp = await funService.Generate("DecimalRange", parameters);
