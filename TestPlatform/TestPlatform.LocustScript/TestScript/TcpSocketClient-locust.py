...
def GetJsonData(data, gettype, endtype):
    ...
    if data and type(data) == dict:
        ...
        if endtype == 0:
            TcpTestUser.environment.runner.quit()
            return None
...
class TcpTestUser(User):
    ...
    def login(self):
        ...
        try:
            ...
            self.recvdata = TcpRRWithConnect(self.client, self.senddata, ".*")
    ...
    def send_data(self):
        ...
        try:
            ...
            self.recvdata = TcpRRWithConnect(self.client, self.senddata, ".*", "name", self)
...
if __name__ == "__main__":
    ...
    os.system(
        "locust -f .\\locust-tcp\\locustfiles\\TcpSocketClient-locust.py")

# locust -f "E:\Documents\Visual Studio Code\TestPython\locust-tcp\locustfiles\TcpSocketClient-locust.py"
# locust -f "E:\Documents\Visual Studio Code\TestPython\locust-tcp\locustfiles\TcpSocketClient-locust.py" --master --master-bind-host 127.0.0.1 --master-bind-port 5557 --expect-workers 1
# locust -f "E:\Documents\Visual Studio Code\TestPython\locust-tcp\locustfiles\TcpSocketClient-locust.py" --worker --master-host 127.0.0.1 --master-port 5557
# locust -f "E:\Documents\Visual Studio Code\TestPython\locust-tcp\locustfiles\TcpSocketClient-locust.py" --headless -u 100 -r 10 -t 1m 
# locust -f "E:\Documents\Visual Studio Code\TestPython\locust-tcp\locustfiles\TcpSocketClient-locust.py" --master --headless --expect-workers 2 -u 100 -r 10 -t 1m  
# locust -f "E:\Documents\Visual Studio Code\TestPython\locust-tcp\locustfiles\TcpSocketClient-locust.py" --worker --master-host 127.0.0.1 --master-port 5557
# locust -f "E:\Documents\Visual Studio Code\TestPython\locust-tcp\locustfiles\TcpSocketClient-locust.py" --logfile "E:\Documents\Visual Studio Code\TestPython\locust-tcp\log\log.log"
# locust -f "E:\Documents\Visual Studio Code\TestPython\locust-tcp\locustfiles\TcpSocketClient-locust.py" --logfile "E:\Documents\Visual Studio Code\TestPython\locust-tcp\log\log.log" --master --headless -u 100 -r 10 -t 1m
# locust -f "E:\Documents\Visual Studio Code\TestPython\locust-tcp\locustfiles\TcpSocketClient-locust.py" --worker --master-host=127.0.0.1 --master-port=5557
