...
namespace IdentityCenter.ClientService
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            //初始化配置容器
            ClientStartupHelper.InitConfigurationContainer(environmentName, baseUrl);
            ...
            //初始化上下文容器
            ClientStartupHelper.InitContext();
            ...
            Host.CreateDefaultBuilder(args)
                .ConfigureWebHostDefaults(webBuilder =>
                {
                    webBuilder.ConfigureServices((context, services) =>
                    {
                        ...
                        //初始化DI容器
                        ClientStartupHelper.InitDI(services, coreConfiguration.DISetting);


                        //初始化静态设置
                        ClientStartupHelper.InitStaticInfo();
                        ClientStartupHelper.InitStaticInfo();
                        ...
                        {
                            ClientStartupHelper.InitLogger(builder);
                        });
